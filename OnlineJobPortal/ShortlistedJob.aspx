<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortlistedJob.aspx.cs" Inherits="OnlineJobPortal.ShortlistedJob" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Qerza - Shortlisted Jobs | Bootstrap HTML Template</title>
    ...
    <meta name="keywords" content="job portal, shortlisted jobs, GridView, Bootstrap HTML template, job listings, user-friendly interface" />
    <meta name="description" content="Qerza - Shortlisted Jobs page for job seekers. View all your shortlisted job applications. User-friendly interface with powerful functionalities." />
    <meta property="og:title" content="Qerza - Shortlisted Jobs | Bootstrap HTML Template" />
    <meta property="og:description" content="Qerza - Shortlisted Jobs page for job seekers. View all your shortlisted job applications. User-friendly interface with powerful functionalities." />
        ...
        <div id="Div1" class="show">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <asp:GridView ID="gvShortlistedJobs" runat="server" CssClass="table table-bordered table-striped"
                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                                        OnPageIndexChanging="gvShortlistedJobs_PageIndexChanging"
                                        OnRowCommand="gvShortlistedJobs_RowCommand">
                                        <Columns>
                    ...
                    <!-- End of Shortlisted Jobs Section -->
                </div>
            </div>
            <!-- Content Body end -->
