...
<head runat="server">
    ...
    <meta name="description" content="JobSeeker Dashboard - Manage Your Jobs and Candidates" />
    <meta name="keywords" content="JobSeeker Dashboard, Job Management, Candidate Search" />
    <meta name="author" content="YourName" />
    <title>JobSeekerDashboard &mdash; Manage Your Jobs and Candidates</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="site-wrap">
            ...
            <header class="top-nav">
                <!-- Site Logo -->
                <asp:Label ID="lblSiteLogo" runat="server" Text="JobSeekerDashboard" CssClass="site-logo" Style="font-size:24px; font-weight:bold; color:#2c3e50;"></asp:Label>
            ...
            <div class="d-flex">
                ...
                <nav class="sidebar d-none d-lg-block">
                    <asp:HyperLink ID="lnkDashboard" runat="server" NavigateUrl="JobSeekerDashboard.aspx" CssClass="active"><span class="icon-home mr-2"></span> Dashboard</asp:HyperLink>
                ...
                <div class="main-content w-100">
                    <div class="container-fluid">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h2>Welcome, <asp:Label ID="lblJobSeekerName" runat="server" Text=""></asp:Label></h2>
                            </div>
                        </div>
