...
<head runat="server">
    <!-- Title -->
    <title>Qerza - Applied Jobs | Bootstrap HTML Template</title>
    ...
    <meta name="keywords" content="job portal, applied jobs, GridView, Bootstrap HTML template, job listings, user-friendly interface" />
    <meta name="description" content="Qerza - Applied Jobs page for job seekers. View all your applied job applications. User-friendly interface with powerful functionalities." />
    <meta property="og:title" content="Qerza - Applied Jobs | Bootstrap HTML Template" />
    <meta property="og:description" content="Qerza - Applied Jobs page for job seekers. View all your applied job applications. User-friendly interface with powerful functionalities." />
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <asp:GridView ID="gvAppliedJobs" runat="server" CssClass="table table-bordered table-striped"
                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                                        OnPageIndexChanging="gvAppliedJobs_PageIndexChanging"
                                        OnRowCommand="gvAppliedJobs_RowCommand">
                                        <Columns>
