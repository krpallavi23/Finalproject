...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="color_1"
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <asp:LinkButton ID="lnkViewProfile" runat="server" CssClass="dropdown-item ai-icon" OnClick="lnkViewDashboard_Click">
                            ...
                            <asp:TemplateField HeaderText="Username">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBoxUsername" runat="server" Text='<%# Bind("Username") %>' 
                                        Required="true" placeholder="Enter username" aria-label="Username" />
                                    <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="TextBoxUsername" 
                            ...
                            <asp:TemplateField HeaderText="Email">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBoxEmail" runat="server" Text='<%# Bind("Email") %>' 
                                        Required="true" placeholder="Enter email" aria-label="Email" />
                                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="TextBoxEmail" 
    ...
    <!-- Include scripts at the bottom for better performance -->
