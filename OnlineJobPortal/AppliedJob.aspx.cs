...
namespace OnlineJobPortal
{
    public partial class AppliedJob : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Binds the GridView with applied job applications.
        /// </summary>
        private void BindJobApplications()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    string query = @"SELECT ja.ApplicationID, jp.Title AS JobTitle, emp.CompanyName, ja.ApplicationDate, ja.Status 
                                     ...
                                     WHERE ja.JobSeekerID = @JobSeekerID AND ja.Status = 'Applied'
            ...
            catch (Exception ex)
            {
                ...
                lblMessage.Text = "An error occurred while loading your applied jobs. Please try again later.";
            }
        }
        ...
        /// </summary>
        protected void gvAppliedJobs_RowCommand(object sender, GridViewCommandEventArgs e)
        {
