<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterviewedCandidates.aspx.cs" Inherits="OnlineJobPortal.InterviewedCandidates" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Online Job Portal - Interviewed Candidates</title>
        ...
        <div id="Div1" class="show">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <!-- Interviewed Candidates Content -->
                    <asp:UpdatePanel ID="UpdatePanelInterviewed" runat="server">
                        <ContentTemplate>
                            <!-- Job Details Section -->
                            ...
                            <div class="table-responsive">
                                <asp:GridView
                                    ID="gvInterviewedCandidates"
                                    runat="server"
                                    CssClass="table table-striped table-bordered"
                                    AutoGenerateColumns="False"
                                    OnRowCommand="gvInterviewedCandidates_RowCommand"
                                    OnRowDataBound="gvInterviewedCandidates_RowDataBound">
                                    <Columns>
