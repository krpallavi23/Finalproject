<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllJobApplications.aspx.cs" Inherits="OnlineJobPortal.AllJobApplications" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Qerza - All Job Applications | Bootstrap HTML Template</title>
    ...
    <meta name="keywords" content="job portal, job applications, GridView, Bootstrap HTML template, job listings, user-friendly interface" />
    <meta name="description" content="Qerza - All Job Applications page for job seekers. View all your job applications irrespective of their status. User-friendly interface with powerful functionalities." />
    <meta property="og:title" content="Qerza - All Job Applications | Bootstrap HTML Template" />
    <meta property="og:description" content="Qerza - All Job Applications page for job seekers. View all your job applications irrespective of their status. User-friendly interface with powerful functionalities." />
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>All Job Applications</h5>
                                </div>
                                <div class="card-body">
                                    <asp:GridView ID="gvAllJobApplications" runat="server" CssClass="table table-bordered table-striped"
                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                                        OnPageIndexChanging="gvAllJobApplications_PageIndexChanging">
                                        <Columns>
                    ...
                    <!-- End of All Job Applications Section -->
                </div>
            </div>
            <!-- Content Body end -->
