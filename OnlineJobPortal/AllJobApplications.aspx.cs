...
{
    public partial class AllJobApplications : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Binds the GridView with all job applications.
        /// </summary>
        private void BindJobApplications()
        {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
                            ...
                            sda.Fill(dt);
                            gvAllJobApplications.DataSource = dt;
                            gvAllJobApplications.DataBind();
                        }
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                lblMessage.Text = "An error occurred while loading your job applications. Please try again later.";
            }
        }
        ...
        /// </summary>
        protected void gvAllJobApplications_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvAllJobApplications.PageIndex = e.NewPageIndex;
            BindJobApplications();
        }
        ...
        /// </summary>
        protected void gvAllJobApplications_RowCommand(object sender, GridViewCommandEventArgs e)
        {
