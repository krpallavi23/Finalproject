<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedJob.aspx.cs" Inherits="OnlineJobPortal.RejectedJob" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <title>Your Rejected Jobs | Online Job Portal</title>
    <meta charset="utf-8" />
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">Rejected Jobs</div>
                            </div>
            ...
            <div class="deznav">
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                        <li><a href="SearchJob.aspx" class="ai-icon"><i class="flaticon-381-search"></i><span class="nav-text">Search Jobs</span></a></li>
                        <li>
                            <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                                <i class="flaticon-381-briefcase"></i><span class="nav-text">Job Application</span>
                            </a>
                        ...
                        <li><a href="LikeJob.aspx" class="ai-icon"><i class="flaticon-381-heart"></i><span class="nav-text">Liked Jobs</span></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Rejected Job Listings</h4>
                                </div>
                                <div class="card-body">
                                    <asp:GridView ID="gvRejectedJobListings" runat="server" CssClass="table table-responsive-lg" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" OnPageIndexChanging="gvRejectedJobListings_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Actions">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Button ID="btnReapply" runat="server" Text="Reapply" CommandArgument='<%# Eval("JobID") %>' OnClick="btnReapply_Click" CssClass="btn btn-success btn-sm ms-2" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
