<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedJobs.aspx.cs" Inherits="OnlineJobPortal.RejectedJobs" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Qerza - Rejected Jobs | Bootstrap HTML Template</title>
    ...
    <meta name="keywords" content="job portal, rejected jobs, GridView, Bootstrap HTML template, job listings, user-friendly interface" />
    <meta name="description" content="Qerza - Rejected Jobs page for job seekers. View all your rejected job applications. User-friendly interface with powerful functionalities." />
    <meta property="og:title" content="Qerza - Rejected Jobs | Bootstrap HTML Template" />
    <meta property="og:description" content="Qerza - Rejected Jobs page for job seekers. View all your rejected job applications. User-friendly interface with powerful functionalities." />
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <asp:GridView ID="gvRejectedJobs" runat="server" CssClass="table table-bordered table-striped"
                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                                        OnPageIndexChanging="gvRejectedJobs_PageIndexChanging"
