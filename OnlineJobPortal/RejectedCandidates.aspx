<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedCandidates.aspx.cs" Inherits="OnlineJobPortal.RejectedCandidates" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Online Job Portal - Rejected Candidates</title>
        ...
        <div id="Div1" class="show">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    ...
                    <asp:UpdatePanel ID="UpdatePanelRejected" runat="server">
                        <ContentTemplate>
                            <!-- Job Details Section -->
                            ...
                            <div class="table-responsive">
                                <asp:GridView
                                    ID="gvRejectedCandidates"
                                    runat="server"
                                    CssClass="table table-striped table-bordered"
                                    AutoGenerateColumns="False"
                                    OnRowCommand="gvRejectedCandidates_RowCommand"
                                    OnRowDataBound="gvRejectedCandidates_RowDataBound">
                                    <Columns>
