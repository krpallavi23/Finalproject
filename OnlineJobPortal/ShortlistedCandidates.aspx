<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortlistedCandidates.aspx.cs" Inherits="OnlineJobPortal.ShortlistedCandidates" %>

<!DOCTYPE html>
<html lang="en" dir="ltr">
<head runat="server">
    <!-- Title -->
    <title>Online Job Portal - Matching Candidates</title>
        ...
        <div id="Div1" class="show">
            ...
            <div class="content-body">
                <div class="container-fluid">
                     <!-- Shortlisted Candidates Content -->
                    <asp:UpdatePanel ID="UpdatePanelShortlisted" runat="server">
                        <ContentTemplate>
                            <!-- Job Details Section -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Application Deadline:</strong>
                                                        <asp:Label ID="lblJobDeadline" runat="server"></asp:Label></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="Actions">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Button
                                                                    ...
                                                                    runat="server"
                                                                    Text="Interview"
                                                                    CommandName="InterviewCandidate"
                                                                    CommandArgument='<%# Eval("Candidate.JobSeekerID") %>'
